...
parser.add_argument("--out", default = "out.tfr", help = "tesorflow data record output file")
...
## writer
record_file = out
print(f'Wrinting tensorflow data record file: {out}')

tf_opts = tf.io.TFRecordOptions(compression_type='GZIP')

count = 0

with tf.io.TFRecordWriter(record_file, tf_opts) as writer:
